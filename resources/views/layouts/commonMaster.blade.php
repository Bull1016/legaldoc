...
<head>
  ...
  <title>
    @yield('title') | {{ optional($organisation)->nameOr }}
  </title>
  <meta name="description"
    content="{{ optional($organisation)->descriptionOr }}" />
  <meta name="keywords"
    content="{{ config('variables.templateKeyword') ? config('variables.templateKeyword') : '' }}" />
  <meta property="og:title" content="{{ optional($organisation)->nameOr }}" />
  ...
  <meta property="og:image" content="{{ asset('storage/' . optional($organisation)->picOr) }}" />
  ...
  <!-- Favicon -->
  <link rel="icon" type="image/x-icon" href="{{ asset('storage/' . optional($organisation)->picOr) }}" />
